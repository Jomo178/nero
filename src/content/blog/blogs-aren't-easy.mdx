---
title: Blogs aren't easy
description: Making blogs is actually rlly hard!
...
<Code language="html" fileDirectory="index.html">
  {`<article class="prose">
...
<Code language="javascript" fileDirectory="tailwind.config.js">
  {`module.exports = {
  purge: [],
  theme: {
    extend: {},
